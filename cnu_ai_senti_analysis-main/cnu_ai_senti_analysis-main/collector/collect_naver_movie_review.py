...
def movie_review_crawler(movie_code):
    ...
    print(f'제목: {title}')
    # 리뷰를 수집하는 코드 작성
    url = 'https://movie.naver.com/movie/bi/mi/pointWriteFormList.naver?code=191657&type=after&isActualPointWriteExecute=false&isMileageSubscriptionAlready=false&isMileageSubscriptionReject=false&page=6'
